 ...
 */
#include "imgurbasicresponse.hh"

using noire::ImgurBasicResponse;

/*!
 * \brief Constructs an ImgurBasicResponse from the JSON \a object.
 */
ImgurBasicResponse::ImgurBasicResponse(const QJsonObject& object) :
