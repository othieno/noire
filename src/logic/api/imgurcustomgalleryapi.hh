 ...
 */
#ifndef IMGURCUSTOMGALLERYAPI_HH
#define IMGURCUSTOMGALLERYAPI_HH

#include "imgurapiendpoint.hh"

namespace noire {

class ImgurCustomGalleryApi final : public ImgurApiEndpoint
{
    friend class ImgurApi;
public:
private:
    ImgurCustomGalleryApi();
};

} // namespace noire

#endif // IMGURCUSTOMGALLERYAPI_HH
